            ...
            case R.id.button_equal:
                try{
                    if (!mEditText.getText().toString().equals("")){
                        com.udojava.evalex.Expression expression = new com.udojava.evalex.Expression(mEditText.getText().toString());
                    ...
                    mEditText.setText("На ноль делить нельзя!");
                }

                catch (Expression.ExpressionException e){
                    mEditText.setText("Недопустимое выражение");
                }

                catch (NumberFormatException e){
                    mEditText.setText("Неверный формат");
                }
                break;
            case R.id.button_pi:
